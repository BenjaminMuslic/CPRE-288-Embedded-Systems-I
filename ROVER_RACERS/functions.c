    ...
    while (br == 0)
    {
        ...
        else
        {
            ...
            if (boundary == 1)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("Boundary line detected: Front left\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (boundary == 2)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("Boundary line detected: Front right\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (boundary == 3)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("Boundary line detected: Left\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (boundary == 4)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("Boundary line detected: Right\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            ...
            if (cliff == 1)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("DANGER!: Water source detected front left\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (cliff == 2)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("DANGER!: Water source detected front right\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (cliff == 3)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("DANGER!: Water source detected left\n\r");
                uart_sendStr(warning);
                br = 1;
            }
            else if (cliff == 4)
            {
                ...
                timer_waitMillis(1500);
                oi_setWheels(0, 0);
                char *warning = ("DANGER!: Water source detected right\n\r");
                uart_sendStr(warning);
                br = 1;
            }
        }
 ...
 *
 *0 = No bump detected *1 = Left bump *2 = Right bump
 *
 */
 ...
 *
 *0 = No boundary detected *1 = Front left detected boundary *2 = Front right detected boundary *3 = Left detected boundary *4 = Right detected boundary
 */
 ...
 *
 *0 = No cliff detected *1 = Front left cliff detected *2 = Front right cliff detected *3 = Left cliff detected *4 = Right cliff detected
 *
 */
...
void reposition()
{
    ...
    while (1)
    {
        ...
        else
        {
            ...
            uint16_t power = (uint16_t)(                difference < -100 ?
