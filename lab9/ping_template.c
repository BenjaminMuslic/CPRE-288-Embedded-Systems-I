...
/*
 * In count-down mode, if the first value is
smaller than the second value read from the timer register, this means the timer counted down to
0x000000, and then wrapped back to 0xFFFFFF.
 */
int overflowCalc() {

    unsigned long cT = current_time;
    unsigned long lT = last_time;
